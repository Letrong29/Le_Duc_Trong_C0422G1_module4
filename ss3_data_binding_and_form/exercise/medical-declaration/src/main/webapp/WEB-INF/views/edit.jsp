...
<div class="container bg-light shadow-lg">
    ...
    <div class="row ">
        <div class="col-lg-12">
            ...
            <form:form action="/update/${medicalDeclaration.id}" method="post" modelAttribute="medicalDeclaration">
                ...
                <div class="row mb-3">
                    <div class="col-lg-4">
                        ...
                        <form:select class="form-control" id="yearOfBirth" path="yearOfBirth" items="${yearOfBirthList}"/>
                    </div>

                    <div class="col-lg-4">
                        <label for="yearOfBirth" class="form-label fw-bold">Giới tính</label>
                        <form:select class="form-control" id="yearOfBirth"  path="gender" items="${genderList}" />
                    </div>

                    <div class="col-lg-4">
                        <label for="nationality" class="form-label fw-bold">Quốc tịch</label>
                        <form:input class="form-control" id="nationality" path="nationality" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <form:input class="form-control" id="idCard" path="idCard"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 mb-3">
                        ...
                        <div>
                            <form:radiobuttons class="form-check-input" id="vehicles" path="vehicles" items="${vehiclesList}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-6">
                        ...
                        <form:input class="form-control" id="licensePlates" path="licensePlates"/>
                    </div>
                    <div class="col-lg-6">
                        <label for="seats" class="form-label fw-bold">Số ghế</label>
                        <form:input class="form-control" id="seats" path="seats"/>
                    </div>
                </div>
